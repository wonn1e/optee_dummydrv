...
/*
* Wonnie DUMMY DRV - fast smc
*/
#define OPTEE_SMC_DUMMY_SUCCESS		1
#define OPTEE_SMC_DUMMY_FAIL		2
#define OPTEE_SMC_FAST_FUNCID_OPEN_CALL  	0x0005
#define OPTEE_SMC_OPEN_DUMMY \
        OPTEE_SMC_FAST_CALL_VAL(OPTEE_SMC_FAST_FUNCID_OPEN_CALL)

#define OPTEE_SMC_FAST_FUNCID_CLOSE_CALL         0x0006
#define OPTEE_SMC_CLOSE_DUMMY \
        OPTEE_SMC_FAST_CALL_VAL(OPTEE_SMC_FAST_FUNCID_CLOSE_CALL)

#define OPTEE_SMC_FAST_FUNCID_READ_CALL         0x0011
#define OPTEE_SMC_READ_DUMMY \
        OPTEE_SMC_FAST_CALL_VAL(OPTEE_SMC_FAST_FUNCID_READ_CALL)

#define OPTEE_SMC_FAST_FUNCID_WRITE_CALL         0x0012
#define OPTEE_SMC_WRITE_DUMMY \
        OPTEE_SMC_FAST_CALL_VAL(OPTEE_SMC_FAST_FUNCID_WRITE_CALL)

#define OPTEE_SMC_FAST_FUNCID_RESET_CALL         0x0013
#define OPTEE_SMC_RESET_DUMMY \
        OPTEE_SMC_FAST_CALL_VAL(OPTEE_SMC_FAST_FUNCID_RESET_CALL)
